...
- **Global scope**: `/home/dullear/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/dullear/.claude/notes/`)
...
2. Glob `/home/dullear/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/dullear/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/dullear/.claude/notes/` — works in any directory
